...
SRCFLS = ../source/poly1271_const.S 		\
	 ../source/poly1271_avx2_maax_g4x3.S	\
	 ../source/poly1271_keypowers.S	\
	 ../source/poly1271_input.c 		\
	 ../source/poly1271.c
         
OBJFLS = ../source/poly1271_const.o 		\
	 ../source/poly1271_avx2_maax_g4x3.o	\
	 ../source/poly1271_keypowers.o	\
	 ../source/poly1271_input.o 		\
	 ../source/poly1271.o

TESTSRC = ./poly1271_g4x3_verify.c
TESTOBJ = ./poly1271_g4x3_verify.o

SPEEDSRC = ./poly1271_g4x3_speed.c
SPEEDOBJ = ./poly1271_g4x3_speed.o

RECORDSRC = ./poly1271_g4x3_record_speed.c
RECORDOBJ = ./poly1271_g4x3_record_speed.o
	  
EXE1    = poly1271_g4x3_verify
EXE2    = poly1271_g4x3_speed
EXE3    = poly1271_g4x3_record_speed
